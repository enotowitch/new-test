		...
		<div class="card card__post-job">
			...
			<form class="post-form">
				...
				<textarea class="card__company-name card__post-job-company-name" id="card__post-job-company-name"
					name="job_company_name" placeholder="Type your company name..." maxlength="50" minlength="2"></textarea>
				<!--  -->
...
<input type="hidden" id="user_id" value="<? echo $_SESSION['user']['user_id'] ?>">
		...
		<!-- ! card__post-job-EXAMPLE -->
		<div class="card card__post-job-example">
			<img class="card__logo" src="img/post-job-logo.png" alt="card__post-job-EXAMPLE-logo">
			<div class="card__job-title card__post-job-example-title">Job title duis ad fugiat do do adipisic</div>
			<div class="card__company-name card__post-job-example-company-name">Company name id do deserunt officia qui
				velit non
				pariatur ut.</div>
			<!--  -->
			<ul class="card__post-job-example-options">
				<li class="card-option__salary">3000 USD</li>
				<li class="card-option__exp">5 years</li>
				...
				<li class="card-option__workload">176 h/mo</li>
